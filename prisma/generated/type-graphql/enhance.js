...
const modelsInfo = {
    ...
    Campground: ["id", "name", "description", "primaryImageB64", "secondaryImageB64s", "address", "price", "userId", "createdAt"],
    Review: ["id", "rating", "body", "userId", "campgroundId", "createdAt"]
};
...
const outputsInfo = {
    ...
    CampgroundGroupBy: ["id", "name", "description", "primaryImageB64", "secondaryImageB64s", "address", "price", "userId", "createdAt", "_count", "_avg", "_sum", "_min", "_max"],
    AggregateReview: ["_count", "_avg", "_sum", "_min", "_max"],
    ReviewGroupBy: ["id", "rating", "body", "userId", "campgroundId", "createdAt", "_count", "_avg", "_sum", "_min", "_max"],
    ...
    CampgroundCountAggregate: ["id", "name", "description", "primaryImageB64", "secondaryImageB64s", "address", "price", "userId", "createdAt", "_all"],
    CampgroundAvgAggregate: ["price"],
    CampgroundSumAggregate: ["price"],
    CampgroundMinAggregate: ["id", "name", "description", "primaryImageB64", "address", "price", "userId", "createdAt"],
    CampgroundMaxAggregate: ["id", "name", "description", "primaryImageB64", "address", "price", "userId", "createdAt"],
    ReviewCountAggregate: ["id", "rating", "body", "userId", "campgroundId", "createdAt", "_all"],
    ReviewAvgAggregate: ["rating"],
    ReviewSumAggregate: ["rating"],
    ReviewMinAggregate: ["id", "rating", "body", "userId", "campgroundId", "createdAt"],
    ReviewMaxAggregate: ["id", "rating", "body", "userId", "campgroundId", "createdAt"]
};
...
const inputsInfo = {
    ...
    CampgroundWhereInput: ["AND", "OR", "NOT", "id", "name", "description", "primaryImageB64", "secondaryImageB64s", "address", "price", "user", "userId", "Review", "createdAt"],
    CampgroundOrderByWithRelationInput: ["id", "name", "description", "primaryImageB64", "secondaryImageB64s", "address", "price", "user", "userId", "Review", "createdAt"],
    CampgroundWhereUniqueInput: ["id"],
    CampgroundOrderByWithAggregationInput: ["id", "name", "description", "primaryImageB64", "secondaryImageB64s", "address", "price", "userId", "createdAt", "_count", "_avg", "_max", "_min", "_sum"],
    CampgroundScalarWhereWithAggregatesInput: ["AND", "OR", "NOT", "id", "name", "description", "primaryImageB64", "secondaryImageB64s", "address", "price", "userId", "createdAt"],
    ReviewWhereInput: ["AND", "OR", "NOT", "id", "rating", "body", "user", "userId", "campground", "campgroundId", "createdAt"],
    ReviewOrderByWithRelationInput: ["id", "rating", "body", "user", "userId", "campground", "campgroundId", "createdAt"],
    ReviewWhereUniqueInput: ["id"],
    ReviewOrderByWithAggregationInput: ["id", "rating", "body", "userId", "campgroundId", "createdAt", "_count", "_avg", "_max", "_min", "_sum"],
    ReviewScalarWhereWithAggregatesInput: ["AND", "OR", "NOT", "id", "rating", "body", "userId", "campgroundId", "createdAt"],
    ...
    CampgroundCreateInput: ["id", "name", "description", "primaryImageB64", "secondaryImageB64s", "address", "price", "user", "Review", "createdAt"],
    CampgroundUpdateInput: ["id", "name", "description", "primaryImageB64", "secondaryImageB64s", "address", "price", "user", "Review", "createdAt"],
    CampgroundCreateManyInput: ["id", "name", "description", "primaryImageB64", "secondaryImageB64s", "address", "price", "userId", "createdAt"],
    CampgroundUpdateManyMutationInput: ["id", "name", "description", "primaryImageB64", "secondaryImageB64s", "address", "price", "createdAt"],
    ReviewCreateInput: ["id", "rating", "body", "user", "campground", "createdAt"],
    ReviewUpdateInput: ["id", "rating", "body", "user", "campground", "createdAt"],
    ReviewCreateManyInput: ["id", "rating", "body", "userId", "campgroundId", "createdAt"],
    ReviewUpdateManyMutationInput: ["id", "rating", "body", "createdAt"],
    ...
    CampgroundCountOrderByAggregateInput: ["id", "name", "description", "primaryImageB64", "secondaryImageB64s", "address", "price", "userId", "createdAt"],
    CampgroundAvgOrderByAggregateInput: ["price"],
    CampgroundMaxOrderByAggregateInput: ["id", "name", "description", "primaryImageB64", "address", "price", "userId", "createdAt"],
    CampgroundMinOrderByAggregateInput: ["id", "name", "description", "primaryImageB64", "address", "price", "userId", "createdAt"],
    CampgroundSumOrderByAggregateInput: ["price"],
    FloatWithAggregatesFilter: ["equals", "in", "notIn", "lt", "lte", "gt", "gte", "not", "_count", "_avg", "_sum", "_min", "_max"],
    IntFilter: ["equals", "in", "notIn", "lt", "lte", "gt", "gte", "not"],
    CampgroundRelationFilter: ["is", "isNot"],
    ReviewCountOrderByAggregateInput: ["id", "rating", "body", "userId", "campgroundId", "createdAt"],
    ReviewAvgOrderByAggregateInput: ["rating"],
    ReviewMaxOrderByAggregateInput: ["id", "rating", "body", "userId", "campgroundId", "createdAt"],
    ReviewMinOrderByAggregateInput: ["id", "rating", "body", "userId", "campgroundId", "createdAt"],
    ...
    CampgroundCreateWithoutUserInput: ["id", "name", "description", "primaryImageB64", "secondaryImageB64s", "address", "price", "Review", "createdAt"],
    CampgroundCreateOrConnectWithoutUserInput: ["where", "create"],
    CampgroundCreateManyUserInputEnvelope: ["data", "skipDuplicates"],
    ReviewCreateWithoutUserInput: ["id", "rating", "body", "campground", "createdAt"],
    ...
    CampgroundScalarWhereInput: ["AND", "OR", "NOT", "id", "name", "description", "primaryImageB64", "secondaryImageB64s", "address", "price", "userId", "createdAt"],
    ...
    ReviewScalarWhereInput: ["AND", "OR", "NOT", "id", "rating", "body", "userId", "campgroundId", "createdAt"],
    ...
    ReviewCreateWithoutCampgroundInput: ["id", "rating", "body", "user", "createdAt"],
    ...
    CampgroundCreateWithoutReviewInput: ["id", "name", "description", "primaryImageB64", "secondaryImageB64s", "address", "price", "user", "createdAt"],
    ...
    CampgroundUpdateWithoutReviewInput: ["id", "name", "description", "primaryImageB64", "secondaryImageB64s", "address", "price", "user", "createdAt"],
    ...
    CampgroundCreateManyUserInput: ["id", "name", "description", "primaryImageB64", "secondaryImageB64s", "address", "price", "createdAt"],
    ReviewCreateManyUserInput: ["id", "rating", "body", "campgroundId", "createdAt"],
    ...
    CampgroundUpdateWithoutUserInput: ["id", "name", "description", "primaryImageB64", "secondaryImageB64s", "address", "price", "Review", "createdAt"],
    ReviewUpdateWithoutUserInput: ["id", "rating", "body", "campground", "createdAt"],
    ReviewCreateManyCampgroundInput: ["id", "rating", "body", "userId", "createdAt"],
    ReviewUpdateWithoutCampgroundInput: ["id", "rating", "body", "user", "createdAt"]
};
